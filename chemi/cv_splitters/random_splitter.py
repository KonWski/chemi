...
class RandomSplitter(Splitter):
    ...
    def split(self, molecule_ids, smiles, labels):
        ...
        shuffled_internal_molecules_id = random.shuffle(internal_molecule_ids)
        ...
        for fold_id in range(self.cv):
            ...
            select_molecules_id = shuffled_internal_molecules_id[index_start: index_end]
            ...
            folds[fold_id]["molecules_id"] = [molecule_ids[molecule_id] for molecule_id in select_molecules_id]
